...
<div class="container padding-bottom-3x mb-1" style="padding-top: 7em;">
    <div class="card mb-3">
        <div class="p-4 text-center text-white text-lg bg-dark rounded-top"><span class="text-uppercase">Tracking Order No - </span><span
                class="text-medium">${order.orderId}</span></div>
        <div class="d-flex flex-wrap flex-sm-nowrap justify-content-between py-3 px-2 bg-secondary">
            <div class="w-100 text-center py-1 px-2"><span class="text-medium" id="order-status">Status:</span></div>
        </div>
        <div class="card-body">
    ...
    <div class="d-flex flex-wrap flex-md-nowrap justify-content-center justify-content-sm-between align-items-center">
        <div class="text-left text-sm-right"><a class="btn btn-outline-primary btn-rounded btn-sm" href="${mvc.uri('OrderController#details', {'id': order.orderId})}">View Order Details</a>
        </div>
    </div>
</div>
...
<script src="${pageContext.request.contextPath}/resources/js/trackorder.js"></script>
